...
export default function WhitelistButton() {
  ...
  return (
    <div className="absolute bottom-10 z-10 left-[50%] translate-x-[-50%]">
      <div className="sparkle-button">
        <button
          className="whitelist-button active:scale-100"
          onMouseEnter={() => {
            playHover(), showParicles()
          }}
        >
          ...
          <span className="text">Join whitelist</span>
        </button>
