          ...
          <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask1_10_60)">
              <rect
                ...
                fill="url(#paint0_linear_10_60)"
              />
              <path
                d="M53 67.875C61.2163 67.875 67.875 61.2163 67.875 53C67.875 44.7837 61.2163 38.125 53 38.125C44.7837 38.125 38.125 44.7837 38.125 53C38.125 61.2163 44.7837 67.875 53 67.875Z"
                stroke="white"
                stroke-width="3.5"
                stroke-miterlimit="2"
              ...
              />
              <path
                d="M53 60C56.8675 60 60 56.8675 60 53C60 49.1325 56.8675 46 53 46C49.1325 46 46 49.1325 46 53C46 56.8675 49.1325 60 53 60Z"
                stroke="white"
                stroke-width="3.5"
                stroke-miterlimit="2"
                stroke-linejoin="round"
